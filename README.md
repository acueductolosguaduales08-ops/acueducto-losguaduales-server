...
16. **Chat interno** (`/api/chat`) — mensajeria de texto/emojis entre Asociado, Tesorero y Administrador. Los mensajes se retienen en PostgreSQL solo 8 dias (el historial completo vive en IndexedDB del cliente); la eliminacion de mensajes exige solicitud + confirmacion del otro participante y la eliminacion de conversaciones completas es exclusiva de Admin/Tesorero.
